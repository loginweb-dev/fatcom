...
Route::get('admin/productos/lista/{categoria}/{subcategoria}/{marca}/{talla}/{genero}/{color}/{search}/{order?}/{typeOrder?}/{cantpaginada?}', 'ProductosController@productos_list');
...
Route::get('admin/productos/get_productoproforma/{pr_id}/{id}', 'ProductosController@get_producto_proforma');
