...
@if(auth()->user()->hasPermission('browse_clientes'))
    @section('page_header')
        <h1 class="page-title">
            <i class="voyager-people"></i> Clientes
        </h1>
        @if(auth()->user()->hasPermission('add_clientes'))
        <a href="{{route('clientes_create')}}" class="btn btn-success btn-add-new">
                                            ...
                                            @forelse ($registros as $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="no-sort no-click text-right" id="bread-actions">
                                                        ...
                                                        <a href="{{route('clientes_edit', ['id'=>$item->id])}}" title="Editar" class="btn btn-sm btn-primary edit">
                                                            <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">Editar</span>
                                                        </a>
                                                        @endif
                                                        {{-- @if(auth()->user()->hasPermission('delete_clientes'))
