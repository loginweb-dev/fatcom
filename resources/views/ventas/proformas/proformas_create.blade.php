            ...
            function agregar_detalle_venta(id, nombre, precio){
                ...
                if(existe){
                    ...
                    $('#detalle_venta').before(`<tr class="tr-detalle" id="tr-${id}" data-id="${id}">
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="number" id="input-precio_${id}" min="1" step="0.1" value="${precio}" name="precio[]" class="form-control" onchange="subtotal('${id}');" onkeyup="subtotal('${id}');" required />
                                                            <span class="input-group-addon">Bs.</span>
                                                        </div>
                                                    </td>
                                                    <td><input type="number" min="1" step="1" class="form-control" id="input-cantidad_${id}" value="1" name="cantidad[]" onchange="subtotal('${id}');" onkeyup="subtotal('${id}');" required></td>
