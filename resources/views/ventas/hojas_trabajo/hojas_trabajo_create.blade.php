            ...
            function agregar_detalle_venta(id, nombre, precio){
                ...
                if(existe){
                    ...
                    $('#detalle_venta').before(`<tr class="tr-detalle" id="tr-${id}" data-id="${id}">
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="number" readonly id="input-precio_${id}" min="1" step="0.01" value="${precio}" name="precio[]" class="form-control" onchange="subtotal('${id}');calcular_cambio()" onkeyup="subtotal('${id}');calcular_cambio()" required />
