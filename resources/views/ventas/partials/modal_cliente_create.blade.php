        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row" id="alert-cliente"></div>
                    <div class="form-group">
                        ...
                        <input type="text" name="razon_social" id="input-modal_razon_social" class="form-control" placeholder="Ingrese el nombre o razón social del cliente" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="nit" id="input-modal_nit" class="form-control" placeholder="Ingrese el NIT o CI del cliente">
                    </div>
                    <div class="form-group">
