...
@section('meta-datos')
    ...
    <meta property="og:url"           content="{{route('categorias_ecommerce', ['id'=>$id])}}" />
    <meta property="og:type"          content="E-Commerce" />
    <meta property="og:title"         content="{{$subcategoria}} " />
    <meta property="og:description"   content="Echa un vistazo a nuestros productos de {{$subcategoria}}." />
...
@section('content')
    <main id="contenido" class="col-md-9 col-sm-12">
        <h1 class="display-5 my-3">{{$subcategoria}} <div class="fb-like" data-href="{{route('categorias_ecommerce', ['id'=>$id])}}" data-width="" data-layout="button_count" data-action="like" data-size="large" data-show-faces="true" data-share="true"></div></h1>
        @php
            $cont = 0;
        @endphp
