                ...
                <table class="table table-hover shopping-cart-wrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="number" style="width:80px" class="form-control" onchange="calcular_total()" onkeyup="calcular_total()" name="cantidad[]" id="input-cantidad{{$cont}}" value="1" min="1" step="1"></td>
                            <td>
                                @php
