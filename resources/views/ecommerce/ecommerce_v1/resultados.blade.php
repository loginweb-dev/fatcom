<header class="border-bottom mb-4 pb-3">
    <div class="form-inline">
        ...
        <div class="btn-group">
            <a href="#" class="btn btn-outline-secondary active" data-toggle="tooltip" title="Lista"><i class="fa fa-bars"></i></a>
            <a href="#" class="btn  btn-outline-secondary" data-toggle="tooltip" title="Cuadrícula"><i class="fa fa-th"></i></a>
        </div>
    </div>
</header>
{{ $productos }}
            ...
            <aside class="col-sm-3">
                <div class="info-aside">
                    ...
                    <p>                        
                        ...
                        <button style="margin:5px" type="button" id="btn-add_carrito" class="btn btn-light btn-block" onclick="cartAdd({{ $item->id }})"> <i class="fa fa-shopping-cart"></i> Agregar</button>
                    </p>
                </div> <!-- info-aside.// -->
            </aside> <!-- col.// -->
        </div> <!-- row.// -->
