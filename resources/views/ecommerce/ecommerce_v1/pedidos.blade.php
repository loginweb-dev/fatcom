...
@if ($ultimo_pedido)
    @section('content')
        <section class="section-pagetop bg" style="background-color: {{ $section ? $section->background : '#fff' }};">
            <div class="container">
                <h2 class="title-page" style="color: {{ $section ? $section->color : '#000' }}">{{ $block ? $block->titulo : 'Mis pedidos' }}</h2>
        ...
        <section class="section-content padding-y mt-5">
            <div class="container">
                <div class="col-md-12 text-center" style="height: 100px">
                    <h4>No tiene ningún pedido aún</h4>
                </div>
            </div>
        </section>
    @endsection
