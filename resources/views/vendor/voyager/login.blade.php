...
<head>
    ...
    <meta property="og:title"         content="Iniciar sesión en {{ setting('empresa.title') }}" />
    <meta property="og:description"   content="{{setting('empresa.description')}}" />
    <meta property="og:image"         content="{{ voyager_asset('images/logo-icon.png') }}" />
                ...
                <form action="{{ route('voyager.login') }}" method="POST">
                    ...
                    <div class="form-group form-group-default" id="passwordGroup">
                        ...
                        <div class="input-group controls">
                            ...
                            <span class="input-group-addon" style="background:#fff;border:0px;font-size:25px;padding:0px;cursos" id="btn-verpassword">
                    ...
                    <div class="form-group" id="rememberMeGroup">
                        <div class="controls">
                        <input type="checkbox" name="remember" value="1"><span class="remember-me-text">Recuerdame</span>
                        </div>
                    </div>
                    ...
                    <a href="{{url('')}}" class="btn btn-danger pull-right" style="padding:9px 20px">
                        Salir <span class="voyager-external"></span>
                    </a>
