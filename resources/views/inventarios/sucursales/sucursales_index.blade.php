...
@if(auth()->user()->hasPermission('browse_sucursales'))
    @section('page_header')
        <h1 class="page-title">
            <i class="voyager-home"></i> Sucursales
        </h1>
        @if(auth()->user()->hasPermission('add_sucursales'))
        <a href="{{route('sucursales_create')}}" class="btn btn-success btn-add-new">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <small class="text-muted">Para volver a ver todas las sucursalez realizar busqueda vacía.</small>
                                        </div>
                                    </div>
                                </div>
